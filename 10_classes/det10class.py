...
MODEL_PATH  = r"C:\Users\Abdullah\Documents\MyWork\FYP\Models\keypoint_model_10_clean.h5"
...
while True:
    ...
    cv2.putText(frame, f"Hands: {hand_count}", (10, 35),
                cv2.FONT_HERSHEY_SIMPLEX, 0.9,
                (0,255,0) if hand_detected else (0,0,255), 2)
    cv2.putText(frame, "10 Classes | ASL Detection", (w-320, 35),
