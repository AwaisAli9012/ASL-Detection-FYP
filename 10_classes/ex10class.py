...
OUTPUT_DIR  = r"C:\Users\Abdullah\Documents\MyWork\FYP\Dataset\keypoints_10_clean"
LABELS_PATH = r"C:\Users\Abdullah\Documents\MyWork\FYP\Models\keypoint_labels_10_clean.json"
...
print(f"Extracting keypoints for 10 classes (with flipped augmentation)...\n")

for idx, cls in enumerate(CLASSES_10):
    ...
    print(f"✅ [{idx+1}/10] {cls}: {found} original + {found} flipped = {found*2} total")
