...
print(f"\nTotal: {len(X)} samples, {INPUT_DIM} features, {len(EMOTIONS)} classes")
...
# ── SAVE ──────────────────────────────────────────────────────────────────────
pickle.dump(final_rf,  open(os.path.join(SAVE_DIR, "emotion_rf.pkl"),     'wb'))
pickle.dump(final_svm, open(os.path.join(SAVE_DIR, "emotion_svm.pkl"),    'wb'))
pickle.dump(meta,      open(os.path.join(SAVE_DIR, "emotion_meta.pkl"),   'wb'))
pickle.dump(scaler,    open(os.path.join(SAVE_DIR, "emotion_scaler.pkl"), 'wb'))
