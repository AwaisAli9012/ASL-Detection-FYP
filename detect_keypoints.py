...
# ─── PATHS ───────────────────────────────────────────────
MODEL_PATH  = r"C:\Users\Abdullah\Documents\MyWork\FYP\Models\keypoint_model.h5"
...
while True:
    ...
    status_text  = f"Hands: {len(result.multi_hand_landmarks) if result.multi_hand_landmarks else 0}"
